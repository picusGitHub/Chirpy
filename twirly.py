...
# Twirly v. 0.1.0 
#
# About: Twirly (TWItter Rogue Library in pYthon) is a Python library for Twitter, which does not need any OAUTH authentication. Diving in Twitter has never been so easy.
